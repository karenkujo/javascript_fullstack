    ...
    <div class="ratings-content" >
      ...
      <div class="rating-select">
        <div class="rating-type">
          <span class="button positive" :class="{active: currentButton === 0}" @click="active(0)">
            全部
            <span class="count">{{rating.length}}</span>
          </span>
          <span class="button positive" :class="{active: currentButton === 1}" @click="active(1)">
            满意
            <span class="count">{{manyiLength}}</span>
          </span>
          <span class="button negative" :class="{active: currentButton === 2}" @click="active(2)">
            不满意
            <span class="count">{{bumanyiLength}}</span>
          </span>
        </div>
      ...
      <div class="rating-wrapper">
        <ul>
          <li class="rating-item" v-for="(item, index) in contentArr" :key="index">
            <div class="avatar">
            ...
            <div class="content">
              ...
              <div class="star-wrapper">
                <span class="star">
                  <v-star :numScore="item.score" v-if="item.score"></v-star>
                </span>
              ...
              <div class="time">{{timestampToTime(item.rateTime)}}</div>
            </div>
          </li>
        </ul>
      </div>
  ...
  computed: {
    contentArr () {
      if (!this.ison) {
        ...
        let arr = []
        for (let item of this.ratingArr) {
          if (item.text !== "") {
            arr.push(item)
          }
        }
