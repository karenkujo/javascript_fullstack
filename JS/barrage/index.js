let data = [
  ...
  {value: '好好听！', time: 11, color: 'blue', speed: 1, fontSize: 25},
  {value: '周杰伦！', time: 13, color: 'pink', speed: 2, fontSize: 15},
  {value: '听妈妈的话', time: 5}
]
...
class CanvasBarrage {
  ...
  clear() {
    this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height) //canvas自带方法  清除画布
  }
  renderBarrage() {
    // 根据视频播放的时间和弹幕出现的时间作比较来判断是否展示弹幕
    let time = this.video.currentTime  //视频当前时间
